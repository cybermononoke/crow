<nav x-data="{ open: false }" class="bg-white border-b border-black">
        ...
        <div class="flex justify-between h-16">
            <div class="flex items-center">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('spendings.create')" :active="request()->routeIs('spendings')">
                        {{ __('Spendings') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            <x-responsive-nav-link :href="route('spendings.create')" :active="request()->routeIs('spendings')">
                {{ __('Spendings') }}
            </x-responsive-nav-link>
